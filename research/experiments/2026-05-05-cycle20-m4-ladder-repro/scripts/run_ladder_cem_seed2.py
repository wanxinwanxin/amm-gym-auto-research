"""
M4 cycle-20 — Third-seed measurement for cycle-19 ladder CEM.

Seed-1 returned lift_FF +3.076 (below cycle-19's +3.251 by 0.175,
outside the [+3.15, +3.35] "reproducible" band). To estimate the
ladder seed-distribution mean and dispersion with n=3, run a third
independent seed (rng_seed=2). All else identical to cycle-19/seed-1.
"""
...
OUTDIR = (
    ROOT
    / "research/experiments/2026-05-05-cycle20-m4-ladder-repro/results/ladder_cem_seed2"
)
...
def main() -> None:
    ...
    _log(
        f"M4 cycle-20 ladder-family CEM third seed | dim={len(names)} | "
